void yz4_q2() {
     ...
     TFile *f3 = TFile::Open("Q2_level_-20mv_amplitude_cut_11mv_header.root");
     TCanvas *c3 = (TCanvas*)f3->Get("c1");
     TH1 *h3 = (TH1*)c3->GetPrimitive("Q_C2_Min_C2");
     c1->cd();
     h3->Draw("same");

     
     TFile *f4 = TFile::Open("Q2_level_-20mv_T3_CL<1_selected_11mv_header.root");
